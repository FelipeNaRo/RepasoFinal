package com.example.felipe.repasofinal;
...
import com.example.felipe.repasofinal.R;

public class repaso_final extends Activity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repaso_final);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_repaso_final, menu);
        return true;
    }
